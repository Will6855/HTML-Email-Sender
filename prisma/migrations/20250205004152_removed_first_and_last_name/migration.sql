/*
  ...
  - You are about to drop the column `firstName` on the `GeneralAccount` table. All the data in the column will be lost.
  - You are about to drop the column `lastName` on the `GeneralAccount` table. All the data in the column will be lost.
